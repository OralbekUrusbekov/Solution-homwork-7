...
/**
  ShuffleSeasonIterator is an implementation of EpisodeIterator that iterates
  over the episodes of a season in a random order, with a fixed seed to ensure repeatability.
 */
